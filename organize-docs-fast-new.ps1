...
$projectReadme = "# Project-Specific Documentation`n`n"
$projectReadme += "Last Updated: $timestamp`n"

$reusableReadme = "# Reusable Knowledge Base`n`n"
$reusableReadme += "Last Updated: $timestamp`n"
...
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Project Docs: $projectDocs\" -ForegroundColor Yellow
$projectCount = (Get-ChildItem $projectDocs -File).Count
Write-Host "   Files: $projectCount" -ForegroundColor White
Write-Host ""
Write-Host "Reusable Docs: $reusableDocs\" -ForegroundColor Yellow
